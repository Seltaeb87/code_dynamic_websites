		...
		<div class="wrapper">
			...
			<div class="sandbox">
				...
				<p><strong><?php echo $gentlemen[0][first_name]; ?></strong> is quite the <strong><?php echo $age_group[2]; ?></strong>! 
							He sports a solid <strong><?php echo $handlebar[name]; ?> </strong>moustache, which has the colour of <strong><?php echo $handlebar[colour]; ?></strong>.</p> 
				
				<h3><?php echo $gentlemen[1][first_name]; ?> from <?php echo $gentlemen[1][country]; ?></h3>
				<p><strong><?php echo $gentlemen[1][first_name]; ?></strong> is quite the <strong><?php echo $age_group[1]; ?></strong>! 
							He sports a solid <strong><?php echo $handlebar[name]; ?> </strong>moustache, which has the colour of <strong><?php echo $handlebar[colour]; ?></strong>.</p> 
				
				<h3><?php echo $gentlemen[2][first_name]; ?> from <?php echo $gentlemen[2][country]; ?></h3>
				<p><strong><?php echo $gentlemen[2][first_name]; ?></strong> is quite the <strong><?php echo $age_group[0]; ?></strong>! 
							He sports a solid <strong><?php echo $handlebar[name]; ?> </strong>moustache, which has the colour of <strong><?php echo $handlebar[colour]; ?></strong>.</p> 
